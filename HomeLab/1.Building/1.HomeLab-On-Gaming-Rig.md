...
- [x] Cilium
- [x] FluxCD
- [x] Ollama - To Run LLM Models Locally
- [x] OpenwebUi - For Accessing Ollama
- [x] Cloudflare Tunnel Operator - Use Clouflare Zero Trust Service to acces different workload over the internet
- [x] Cloudnative Postgresql - Postgresql Operator to 
- [x] Redis
- [x] PaperlessNGX
- [x] Immich
- [x] JellyFin
