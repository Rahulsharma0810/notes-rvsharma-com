...
This would be pretty simple mount, the Graphic card to PCI Slot (Near to CPU as 2nd doesn't has room). Connect 12Pin Cable to GPU and PowerSupply. See Screws are tight enough.
...
Upgrade the node with Extensions, Only Use Nvidia extensions on node with 



Get the URL from Talos Boot Disk

```
talosctl upgrade --nodes 192.168.0.5 \
  --image factory.talos.dev/installer/914b38adefad3d77212f565745ed52013bf3a424e7da2730e9e7dad8ee297342:v1.9.3
```
