...
| Worker v1.8.3        | 1            | 1 Socket, 16 Cores, Host CPU | 48GB       | 200GB (local-lvm)<br>1500 GB<br>2 X 250 GB SSD<br>2 X 120 GB SSD | 192.168.0.6    |

Downloaded the ISO with the following configuration:

Did not enabled Secure Boot as it required kernel flags that I was not sure about.
